class User
  ...
  def update_location_and_alerts
    ...
    alerts_raw = RestClient.get("http://www.mapquestapi.com/traffic/v1/incidents?key=#{ENV['MAPQUEST_KEY']}&boundingBox=37.660066,-122.415976,37.223928,-121.866659&filters=construction,incidents&inFormat=kvp&outFormat=json")
